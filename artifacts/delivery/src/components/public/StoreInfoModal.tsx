...
import { MapPin, Phone, Clock, ShoppingBag, X, DollarSign, Instagram, Facebook, Youtube, Linkedin, Send, Globe, Twitter, CreditCard, Smartphone, Receipt, Wallet, Motorbike } from "lucide-react";
            ...
            <CardContent className="p-4">
              ...
              <div className="space-y-3">
                {company.delivery_time && (
                  <div className="flex items-center space-x-3">
                    <Motorbike className="w-5 h-5 text-muted-foreground flex-shrink-0" />
                    <div className="min-w-0">
                ...
                <div className="flex items-start space-x-3">
                  <Motorbike className="w-5 h-5 text-muted-foreground flex-shrink-0 mt-0.5" />
                  <div className="min-w-0">
