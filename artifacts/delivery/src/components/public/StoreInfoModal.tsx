...
import { MapPin, Phone, Clock, ShoppingBag, X, DollarSign, Instagram, Facebook, Youtube, Linkedin, Send, Globe, CreditCard, Smartphone, Receipt, Wallet, Motorbike } from "lucide-react";
